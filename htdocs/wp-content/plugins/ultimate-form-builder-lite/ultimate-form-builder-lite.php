...
/*
* replace all 'manage_options' in this file with 'edit_pages'
* to allow editor use this plugin in CI-WP
* 
*/ 
 ...
 */
global $wpdb;
defined( 'UFBL_VERSION' ) or define( 'UFBL_VERSION', '1.3.5' ); //plugin version
...
if ( !class_exists( 'UFBL_Class' ) ) {
	...
	class UFBL_Class {
		 ...
		 */
		function ufbl_menu() {
			add_menu_page( __( 'Forms', 'ultimate-form-builder-lite' ), __( 'Forms', 'ultimate-form-builder-lite' ), 'edit_pages', UFBL_SLUG, array( $this, 'forms_list' ),'dashicons-welcome-widgets-menus',35.7 );
			add_submenu_page( UFBL_SLUG, isset( $_GET['form_id'] ) ? __( 'Edit Form', 'ultimate-form-builder-lite' ) : __( 'All Forms', 'ultimate-form-builder-lite' ), __( 'All Forms', 'ultimate-form-builder-lite' ), 'edit_pages', UFBL_SLUG, array( $this, 'forms_list' ) );
			add_submenu_page( UFBL_SLUG, __( 'New Form', 'ultimate-form-builder-lite' ), __( 'New Form', 'ultimate-form-builder-lite' ), 'edit_pages', 'ufbl-new-form', array( $this, 'add_new_form' ) ); 
			add_submenu_page( UFBL_SLUG, __( 'Form Entries', 'ultimate-form-builder-lite' ), __( 'Form Entries', 'ultimate-form-builder-lite' ), 'edit_pages', 'ufbl-form-entries', array( $this, 'forms_entries' ) );
			add_submenu_page( UFBL_SLUG, __( 'How to use', 'ultimate-form-builder-lite' ), __( 'How to use', 'ultimate-form-builder-lite' ), 'edit_pages', 'ufbl-how-to-use', array( $this, 'how_to_use' ) );
			add_submenu_page( UFBL_SLUG, __( 'About', 'ultimate-form-builder-lite' ), __( 'About', 'ultimate-form-builder-lite' ), 'edit_pages', 'ufbl-about', array( $this, 'about' ) );
		}
