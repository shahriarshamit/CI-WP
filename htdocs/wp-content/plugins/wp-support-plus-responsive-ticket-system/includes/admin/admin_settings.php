...
<ul class="nav nav-tabs">
	<li class="active"><a href="#settingsGeneral" id="tab_general_container" data-toggle="tab"><?php _e('General','wp-support-plus-responsive-ticket-system');?></a></li>
...
<input type="hidden" id="wpsp_settings_nonce" value="<?php echo wp_create_nonce();?>"/>