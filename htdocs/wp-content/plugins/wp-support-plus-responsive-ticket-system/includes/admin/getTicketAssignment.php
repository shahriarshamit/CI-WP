...
<button class="btn btn-success changeTicketSubBtn" onclick="setTicketAssignment(<?php echo $ticket_id;?>);"><?php _e('Save Changes','wp-support-plus-responsive-ticket-system');?></button>
<script>
