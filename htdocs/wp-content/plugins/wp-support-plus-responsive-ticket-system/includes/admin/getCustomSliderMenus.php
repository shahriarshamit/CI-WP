...
<div id="menuDisplayTableContainer" class="table-responsive">
	<table class="table table-striped">
	  ...
	  <?php foreach ($menus as $menu){?>
	  	<tr>
	  		<td><img alt="cust_slider" class="cusom_slider_menu_icon" src="<?php echo $menu->menu_icon;?>" ></td>
	  		<td><?php echo $menu->menu_text;?></td>
	  		<td><a target="_blank" href="<?php echo $menu->redirect_url;?>"><?php echo $menu->redirect_url;?></a></td>
	  		<td><img alt="delete" onclick="delete_custom_menu(<?php echo $menu->id;?>);" style="cursor: pointer;" title="<?php _e('Delete','wp-support-plus-responsive-ticket-system');?>" src="<?php echo WCE_PLUGIN_URL;?>asset/images/delete.png" ></td>
	  	</tr>
	  <?php }?>
	</table>
</div>
...
<div id="add_custom_menu_container">
	...
	<table>
		<tr>
			...
			<td><img alt="menu_icon" id="cusom_slider_menu_icon" onclick="change_default_menu_icon();" src="<?php echo WCE_PLUGIN_URL;?>asset/images/custom_menu_default.jpg" ></td>
		</tr>
		<tr>
