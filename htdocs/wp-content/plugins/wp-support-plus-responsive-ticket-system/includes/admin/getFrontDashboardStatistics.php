...
foreach($statusses as $status){
    if(array_search($status->id, $hideStatuses)>-1){
        continue;
    }
    ...
    $sql=apply_filters('wpsp_frontend_dashboard_ticket_statistics_sql',$sql,$status);
...
<?php do_action('wpsp_after_statistics_dashboard_frontend');?>