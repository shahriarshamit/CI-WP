		...
		<tr>
			...
			<td>
				<select id="filter_by_status" name="filter_by_status">
					...
					?>
                                <?php if($cu->has_cap('manage_options')){
                                ?>
                                <option value="deleted" <?php echo ($user_filter['filter_by_status']=='deleted')?'selected="selected"':'';?>><?php _e('Deleted','wp-support-plus-responsive-ticket-system');?></option>
                                <?php
                                }?>
				</select>
			</td>
