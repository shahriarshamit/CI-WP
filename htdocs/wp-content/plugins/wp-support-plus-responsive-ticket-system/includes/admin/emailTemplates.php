...
<ul class="nav nav-tabs">
	...
	<li><a href="#settingsCustomStatus" id="tab_custom_status_container" data-toggle="tab"><?php _e($advancedSettings['ticket_label_alice'][9],'wp-support-plus-responsive-ticket-system');?></a></li>
...
<input type="hidden" id="wpsp_email_template_nonce" value="<?php echo wp_create_nonce();?>"/>