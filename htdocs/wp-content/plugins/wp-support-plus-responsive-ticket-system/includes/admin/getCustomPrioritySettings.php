	  	...
	  	<tr>
			...
			<td style="display:none;"><?php echo $priority->id;?></td>
	  		<td>
				...
				if(!in_array($priority->name,$priority_names)){
				?>
				<img alt="delete" onclick="delete_custom_priority(<?php echo $priority->id;?>);" style="cursor: pointer;" title="<?php _e('Delete','wp-support-plus-responsive-ticket-system');?>" src="<?php echo WCE_PLUGIN_URL;?>asset/images/delete.png" >
				<?php 
				}
				?>
			</td>
	  		...
	  		<td><img alt="set" onclick="save_custom_priority_color(<?php echo $priority->id;?>);" style="cursor: pointer;" title="<?php _e('Update','wp-support-plus-responsive-ticket-system');?>" src="<?php echo WCE_PLUGIN_URL;?>asset/images/save.png" > <span class="custom-priority-color-saved" id="custom-priority-color-saved-<?php echo $priority->id;?>">Saved!</span></td>
	  	</tr>
	  <?php }?>
	</tbody>
