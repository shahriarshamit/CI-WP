...
<form id="wpsp_upload_icons">
    <table id="wpsp_support_image">
        <tr>        
            <td><img alt="support_img"  src="<?php echo $supportImageOption['leftSupportButton'];?>" style="width: 47px; height: 168px;" id="wpsp_left_img"></td>
        ...
        <tr>
            <td><img alt="support_img" src="<?php echo $supportImageOption['rightSupportButton'];?>" style="width: 47px; height: 168px;"  id="wpsp_right_img"></td>
    ...
    <table id="wpsp_support_panel">
        <tr>
            <td><img alt="panel_img" src="<?php echo $supportImageOption['panel_image'];?>" style="width: 40px; height: 40px;"  id="wpsp_panel_img"></td>
