...
<form id='frmETAssignAgent'>
	...
	<button id="wpsp_save_et_cteate_new_ticket" type="submit" class="btn btn-success"><?php _e("Save Settings", 'wp-support-plus-responsive-ticket-system' );?></button>
        <button id="wpsp_reset_et_assign_agent_ticket" type="submit" onclick="resetETAssignAgent(event)" class="btn btn-success"><?php _e("Reset Settings", 'wp-support-plus-responsive-ticket-system' );?></button>
</form>
